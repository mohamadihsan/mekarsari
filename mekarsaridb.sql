...
--
-- Host: 127.0.0.1
-- Generation Time: 24 Jul 2017 pada 01.51
-- Versi Server: 5.7.14
-- PHP Version: 5.6.25
...
(12, 14, '2017-07-23 10:32:20', 'masuk', 10),
(13, 14, '2017-07-23 10:32:37', 'keluar', 5),
(14, 13, '2017-07-23 10:33:51', 'masuk', 3);
...
--
-- Dumping data untuk tabel `arus_produk`
--

INSERT INTO `arus_produk` (`id`, `id_produk`, `waktu`, `status`, `jumlah`) VALUES
(1, 5, '2017-07-23 10:34:11', 'masuk', 10),
(2, 5, '2017-07-23 10:37:33', 'masuk', 10);
...
INSERT INTO `detail_penjualan_produk` (`produk`, `faktur`, `jumlah`, `satuan`, `harga`) VALUES
(5, 1, 13920, 'botol', 1000),
(5, 2, 13740, 'botol', 1000),
(5, 3, 13560, 'botol', 1000),
(5, 4, 13960, 'botol', 1000),
(5, 5, 14060, 'botol', 1000),
(5, 6, 13960, 'botol', 1000);
...
INSERT INTO `kendaraan` (`id`, `plat_nomor`, `nama`, `tujuan_pengiriman`, `kapasitas`, `supir`) VALUES
(1, 'D 1234 EZ', 'MOBIL BOX', 'dalam kota', 1500, 8);
...
INSERT INTO `pegawai` (`id`, `nip`, `nama_lengkap`, `nama_panggilan`, `jabatan`, `email`, `nama_pengguna`, `kata_sandi`) VALUES
(1, '10112645', 'Nama Kepala Administrasi', 'Kep. Adm', 'kepala administrasi', NULL, 'admin', '21232f297a57a5a743894a0e4a801fc3'),
(2, '00000000', 'Maman Abdurahman', 'Maman', 'staff gudang', NULL, 'sgudang', '39ab4e99fc29004971b30f4c7cec1d84'),
(3, '00000001', 'Nama Kepala Gudang', 'Kep. Gud', 'kepala gudang dan pengadaan', NULL, 'kgudang', 'e7e32f1146da57e681cf5e634d72cc7a'),
(4, '00000002', 'Nama Kepala Pemsaran', 'Kep. Pem', 'kepala pemasaran', NULL, 'kpemasaran', '0dd980b6b0b3598be4759c9c2a7d32ec'),
(5, '00000003', 'Nama Kepala Produksi', 'Kep. Prod', 'kepala produksi', NULL, 'kproduksi', '036a2ff235d294544e68d9a252d0cfdf'),
(6, '00000004', 'Manager', 'Man', 'manager', NULL, 'manager', '1d0258c2440a8d19e716292b231e3190'),
(7, '00000005', 'Nama Staff Keaungan', 'Stf. Keu', 'staff keuangan', NULL, 'skeuangan', '9df53dae7fe8395e28827b8d58c01e3d'),
(8, '00000006', 'Nama Sales', 'Salesman', 'staff promosi', NULL, 'sales', '9ed083b1436e5f40ef984b28255eef18');
...
INSERT INTO `pelanggan` (`id`, `kode`, `nama`, `kota`, `alamat`, `no_telp`, `email`, `nama_pengguna`, `kata_sandi`) VALUES
(1, 'MS/PEL-1', 'Mohamad Ihsan', 'dalam kota', 'Jl. Simpay Asih Asih, Ujung Berung, Bandung', '085720054204', 'mohamad_ihsan100@yahoo.co.id', 'ihsan', 'f9c8074d5a013e0729373f8f74cd0648');
...
CREATE TABLE `pemesanan_produk` (
  ...
  `tanggal_pembayaran` datetime DEFAULT NULL COMMENT 'TANGGAL VALIDASI PEMBAYARAN'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `pemesanan_produk` (`id`, `nomor_faktur`, `tanggal`, `pelanggan`, `pegawai`, `status_pesanan`, `status_pembayaran`, `metode_pembayaran`, `tanggal_pembayaran`) VALUES
(1, 'F/010816-000000/MS', '2016-08-01 00:00:00', 1, 4, 'S', 'S', 'CASH', '2016-08-01 00:00:00'),
(2, 'F/010916-000000/MS', '2016-09-01 00:00:00', 1, 4, 'S', 'S', 'CASH', '2016-09-01 00:00:00'),
(3, 'F/011016-000000/MS', '2016-10-01 00:00:00', 1, 4, 'S', 'S', 'CASH', '2016-10-01 00:00:00'),
(4, 'F/011116-000000/MS', '2016-11-01 00:00:00', 1, 4, 'S', 'S', 'CASH', '2016-11-01 00:00:00'),
(5, 'F/011216-000000/MS', '2016-12-01 00:00:00', 1, 4, 'S', 'S', 'CASH', '2016-12-01 00:00:00'),
(6, 'F/010117-000000/MS', '2017-01-01 00:00:00', 1, 4, 'S', 'S', 'CASH', '2017-01-01 00:00:00');
...
INSERT INTO `produk` (`id`, `kode`, `nama`, `jenis_kemasan`, `harga`, `satuan`) VALUES
(5, 'MS/P/0001', 'Kecap', 'botol 600 ml', 500, 'botol');
...
--
ALTER TABLE `pemesanan_produk`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID FAKTUR PENJUALAN', AUTO_INCREMENT=7;
--
